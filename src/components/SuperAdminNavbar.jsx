...
const SuperAdminSidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      name: 'Bots',
      icon: Bot,
      route: '/super-admin/bots',
      path: '/super-admin/bots'
    }
  ];
      ...
      <div className="hidden lg:block fixed left-0 top-0 h-full w-20 bg-gradient-to-b from-purple-900 via-purple-800 to-purple-700 shadow-2xl z-40">
        <div className="flex flex-col h-full">
          ...
          <div className="h-20 flex items-center justify-center border-b border-purple-600">
            ...
            >
              <span className="text-purple-800 font-bold text-lg">SA</span>
            </motion.div>
          </div>
              ...
              <div className="p-6 border-b border-purple-600">
                ...
                >
                  <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-3">
                    <span className="text-purple-800 font-bold text-xl">SA</span>
                  </div>
                  <h2 className="text-white text-xl font-bold">Super Admin</h2>
                  <p className="text-purple-200 text-sm">Dashboard Panel</p>
                </motion.div>
              </div>
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="h-20 flex items-center px-6 border-b border-purple-600">
                ...
                >
                  ...
                  <div>
                    <h2 className="text-white text-lg font-bold">Super Admin</h2>
                    <p className="text-purple-200 text-xs">Dashboard Panel</p>
                  </div>
                </motion.div>
              </div>
